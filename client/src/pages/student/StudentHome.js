import StudentHomeBreadcrumb from "../../components/breadcrumbs/StudentHomeBreadcrumb";
                ...
                <div className="row">
                    ...
                    <div className="col-12 mb-4">
                        <div className="card h-100">
                            <div className="card-heading bg-dark text-white">
...
export default connect(map_state_to_props, {})(StudentHome)